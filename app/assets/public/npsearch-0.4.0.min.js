...
$(".add_to_scratch").change(function() {
  update_scratch_space(this)
});
...
function update_scratch_space(this_checked){
  var id  = $(this_checked).closest( '.collapsible-body' ).find('.id').text().trim();
  var seq = $(this_checked).closest( '.collapsible-body' ).find('.seq').text().trim();
  var model = $(this_checked).closest( '.collapsible-body' ).siblings('.collapsible-header').find('.model_name').text().trim();
  var full_seq = id + ' [HMM Model: ' + model + ']' + '\n' + seq + '\n';
  $('#scratch_space_label').addClass('active'); 
  if($(this_checked).prop('checked')) {
    $('#scratch_space').val(   $('#scratch_space').val() + full_seq );
    $('#scratch_space').trigger('autoresize');
  } else {
    $('#scratch_space').val(   $('#scratch_space').val().replace(full_seq, '')   );
    $('#scratch_space').trigger('autoresize');
  }
}
